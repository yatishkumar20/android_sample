package com.yatish.shhh.provider;
...
import static com.yatish.shhh.provider.PlaceContract.PlaceEntry;
...
public class PlaceContentProvider extends ContentProvider {
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        getContext().getContentResolver().delete(PlaceEntry.CONTENT_URI,selection,selectionArgs);
        return placesDeleted;*/
